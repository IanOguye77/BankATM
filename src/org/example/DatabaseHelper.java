...
public class DatabaseHelper {
    ...
    private static final String DB_PASSWORD ="246813579";
    ...
    public static List<Account> getAccountByUserid(int userId)throws SQLException{
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
            ...
            while (rs.next()) {
                ...
                accounts.add(new Account(accountId, accountNumber, balance, userId));
            }
        }
        return accounts;
    }
    //a method to create a transaction
    public static void createTransaction(int accountId, double amount, String transaction)throws SQLException{
        String sql = "INSERT INTO transactions (account_id, amount, transaction, timestamp) VALUES(?, ?, ?, ?)";
    ...
    public static  List<Transaction> getTransactionHistory(int accountId)throws  SQLException{
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)){
            ...
            while (rs.next()) {
                ...
                transactions.add(new Transaction(transactionId, accountId, amount, transactionType, timeStamp));
            }
        }
        return transactions;
    }
